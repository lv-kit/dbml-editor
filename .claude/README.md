...
| `hooks/` | ガードレール（PreToolUse/PostToolUse/SessionStart/PreCompact/Stop） | 12 |
| `agents/` | subagent 定義（tools 最小化・高推論は planner-deep のみ） | 12 |
...
| 状態 | session-start-context, pre-compact-save, post-stop-summary |

## agents 一覧

planner, planner-deep, code-explorer, code-reviewer, security-reviewer, svelte-reviewer, database-reviewer, performance-optimizer, tdd-guide, build-error-resolver, code-simplifier, doc-updater
